...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	СписаниеТовараСписокНоменклатуры.Номенклатура КАК Номенклатура,
	|	СУММА(СписаниеТовараСписокНоменклатуры.Количество) КАК Количество
	|ПОМЕСТИТЬ втТЧТовары
	|ИЗ
	|	Документ.СписаниеТовара.СписокНоменклатуры КАК СписаниеТовараСписокНоменклатуры
	|ГДЕ
	|	СписаниеТовараСписокНоменклатуры.Ссылка = &Ссылка
	|СГРУППИРОВАТЬ ПО
	|	СписаниеТовараСписокНоменклатуры.Номенклатура
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Номенклатура
	|;
